		...
		do {
			...
			case "veg" -> {
				...
				do {
					...
					System.out.print("Do you want to add another item in veggies ? (y/n): ");
					choice = sc.next();

				} while (choice.equalsIgnoreCase("y"));
				System.out.println("END OF NON VEG LIST");
			}
			...
			case "nonveg" -> {
				...
				do {
					...
					System.out.print("Do you want to add another item in nonveg? (y/n): ");
					choice = sc.next();

				} while (choice.equalsIgnoreCase("y"));
				System.out.println("END OS VEGGIES LIST");
			}

			default -> System.out.println("Item type not available");
			}
			System.out.println("Do you want to continue on veg / nonveg(y/n) :");
			ch = sc.next().charAt(0);
		} while (ch == 'y' || ch == 'Y');
		System.out.println("\n========== BILL ==========");
